...
function createMenuItem(name, i, cat){
  const MenuItem = {
    name:'name',
    price:'i',
    category:'cat',
...
console.log (createMenuItem("pancakes", 6, "breakfast"));
...
return string = "{this.name} gave the restaurant a {this.rating} star review, and their feedback was: {this.feedback}";
}
...
return string = "{name} gave the restaurant a {rating} star review, and their feedback was: {feedback}";
}
} 
